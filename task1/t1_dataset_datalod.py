...
class ModelDataset(Dataset):
    ...
    def __init__(self, data, distilroberta_token, is_tran, max_length=128):
        self.data = data
...
data_tran_t1 = pd.read_json('/root/COMP90042/data/data2/data_tran_t1.json', orient='records', lines=True)
data_vald_t1 = pd.read_json('/root/COMP90042/data/data2/data_vald_t1.json', orient='records', lines=True)
data_test_t1 = pd.read_json('/root/COMP90042/data/data2/data_test_t1.json', orient='records', lines=True)
data_evdn    = pd.read_json('/root/COMP90042/data/data2/data_evdn.json', orient='records', lines=True)

dataset_tran = ModelDataset(data_tran_t1, distilroberta_token, is_tran=True)
dataset_vald = ModelDataset(data_vald_t1, distilroberta_token, is_tran=True)
dataset_test = ModelDataset(data_test_t1, distilroberta_token, is_tran=False)
